...
export default function Landing() {
  ...
  return (
    <div className="cursor-none">
      ...
      <div className="min-h-screen flex flex-col items-center justify-center gap-8 px-6 md:px-[52px] relative overflow-hidden bg-background border-t border-border" id="how" data-testid="section-cta">
        <div className="font-serif text-[clamp(48px,8vw,110px)] font-light leading-[0.93] tracking-tight text-center">
        ...
        <div className="flex gap-4 flex-wrap justify-center" data-testid="cta-buttons">
          <Link
            href="/login"
        ...
        <div className="text-[8px] tracking-[1.5px] uppercase text-muted-foreground" data-testid="text-emergency-note">
          in emergencies call 911
        </div>
      </div>

      <div className="py-24 px-6 md:px-[52px] bg-background border-t border-border" id="levels" data-testid="section-levels">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-px bg-border">
            {[
              ...
              <div key={item.level} className="bg-background p-8 flex flex-col gap-4" data-testid={`card-level-${item.level.toLowerCase()}`}>
      ...
      <footer className="py-12 px-6 md:px-[52px] bg-background border-t border-border" data-testid="footer">
